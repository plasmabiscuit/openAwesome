...
>
	<div class="py-1 overflow-y-scroll max-h-[28rem] md:max-h-full">
		...
		<div class="mt-3 mb-1 ml-1">
			<button
				type="button"
				class=" px-3.5 py-1.5 font-medium hover:bg-black/5 dark:hover:bg-white/5 outline outline-1 outline-gray-300 dark:outline-gray-800 rounded-3xl snes-button"
				on:click={() => {
