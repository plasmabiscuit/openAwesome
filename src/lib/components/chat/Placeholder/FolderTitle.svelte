...
{#if folder}
	...
	<div class="mb-3 px-6 @md:max-w-3xl justify-between w-full flex relative group items-center">
		<div class="text-center flex gap-3.5 items-center">
			...
			>
				<button
					class=" rounded-full bg-gray-50 dark:bg-gray-800 size-11 flex justify-center items-center snes-button"
				>
					{#if folder?.meta?.icon}
		...
		<div class="flex items-center translate-x-2.5">
			...
			>
				<button class="p-1.5 dark:hover:bg-gray-850 rounded-full touch-auto snes-button" on:click={(e) => {}}>
